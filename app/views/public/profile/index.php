 <!--Profile <!--Top-->
                <div id="profile-top">
                    <div class="top-left">
                        <img class="border" width="300" src="<?php echo base_url(); ?>assets/images/avatars/<?php echo $user_fields->avatar; ?>" alt="Member" />
                    </div><!--top-left-->
                    <div class="top-right">
                        <div class="profile-social">
                            ...
                            <?php endif; ?>
                            <?php if(isset($profile_fields->twitter)) : ?>
...
adipiscing elit.
                    ...
                    <div id="profile-about">
                        ...
                        <div class="about-me">
                            <h3>About Me</h3>
                            <?php echo $profile_fields->about_me; ?>
                        </div><!--about me end-->
                        <br />
